...
<body>
	<form id="join_form" method="post" onsubmit="return CheckForm()">
		<p class="ex01">
			<strong>join</strong>
		</p>
		<table style="width: 1100px;" align="center">
			...
			<tr>
				...
				<td colspan="4"><input type="text" class="address_input_1"
					...
					</div> <input type="text" class="address_input_2" name="addressDetail2"
					 ><br> <input type="text"
					class="address_input_3" name="addressDetail3" >&nbsp;<span
					id="checkaddressDetail"></span></td>
			</tr>
			<tr>
				<td>전화번호</td>
				...
				</select>- <input type="tel" name="phone2" maxlength="4">- <input
					type="tel" name="phone3" maxlength="4">&nbsp;<span
...
※ 동의를 거부할 수 있으나 거부시 회원 가입이 불가능합니다.
		...
		<p align="center">
			<br> <input type="button" class="join_button" value="가입하기">
