	...
	<section id="container">
		...
		<div align="center">
			...
			<table>
				...
				<tr>
					<td><input type="checkbox" name="RowCheck" class="RowCheck" value="${product.productId}"></td>
					<td><a href="/admin/Update?productId=${product.productId}"><c:out value="${product.productId}"></c:out></a></td>
