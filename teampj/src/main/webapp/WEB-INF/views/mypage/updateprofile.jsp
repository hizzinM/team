	...
	<section id="container">
		...
		<div class="form-group has-feedback">
			<label class="control-label" for="accountName">예금주</label> <input
				class="form-control" type="text" id="accountName" name="accountName"
				value='<c:out value="${loginuser.accountName}"/>' />
		</div>
		<div class="form-group has-feedback">
			<label class="control-label" for="accountBank">은행</label> <input
				class="form-control" type="text" id="accountBank" name="accountBank"
		...
		<div>
			<a class="btn" id="list_btn">취소</a> <a class="btn" id="modify_btn">수정</a>
		</div>
		...
		<script type="text/javascript">
			...
			$("#modify_btn").on("click", function(e) {
				form.attr("action", "/mypage/memberUpdate");
				form.submit();
			});
		</script>
	</section>
